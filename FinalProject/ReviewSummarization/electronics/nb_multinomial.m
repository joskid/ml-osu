...
vocab = importdata('elec_more_train_vocabulary.txt');
no_of_words = length(vocab);
newslabels = importdata('newsgrouplabels.txt');
no_of_labels = length(newslabels);

% Loading training data
train_data = load('elec_more_train.data');
train_labels = load('elec_more_train.labels');
...
%load test data
test_data = load('elec_more_test.data');
test_labels = load('elec_more_test.labels');
