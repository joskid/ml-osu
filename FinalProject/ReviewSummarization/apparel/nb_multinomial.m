...
vocab = importdata('apparel_train_vocabulary.txt');
no_of_words = length(vocab);
newslabels = importdata('newsgrouplabels.txt');
no_of_labels = length(newslabels);

% Loading training data
train_data = load('apparel_train.data');
train_labels = load('apparel_train.labels');
...
%load test data
test_data = load('apparel_test.data');
test_labels = load('apparel_test.labels');
